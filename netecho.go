...
var detail = flag.Bool("d",false,`This program can resp some useful infomation[REQ,SVRADDR,CLTADDR] to client,not just request info.`)


func useage(){
	fmt.Fprintf(os.Stderr,`netecho	version: netecho/0.0.1 	
A small echo program to reply client the same info as they send.
Usage: netecho [-t tcpports] [-u udpports] [-o respformat]
